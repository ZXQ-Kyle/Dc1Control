...
import info.ponyo.dc1control.base.BaseApplication;
...
public final class SpanUtil {
    ...
    private CharSequence fontSizeTagCS = "[SpanUtil]";

    /**
     * 创见实例
     */
    public static SpanUtil build() {
        return new SpanUtil();
    }
     ...
     */
    public SpanUtil setFontSizeTagCS(CharSequence fontSizeTagCS) {
...
//            }
    ...
    class CustomImageSpan extends CustomDynamicDrawableSpan {
        ...
        private CustomImageSpan(final Bitmap b, final int verticalAlignment) {
            ...
            mDrawable = new BitmapDrawable(BaseApplication.instance.getResources(), b);
            mDrawable.setBounds(
        ...
        public Drawable getDrawable() {
            ...
            if (mDrawable != null) {
                ...
                Bitmap bitmap;
                try {
                    InputStream is = BaseApplication.instance.getContentResolver().openInputStream(mContentUri);
                    bitmap = BitmapFactory.decodeStream(is);
                    drawable = new BitmapDrawable(BaseApplication.instance.getResources(), bitmap);
                    drawable.setBounds(
                ...
                try {
                    drawable = ContextCompat.getDrawable(BaseApplication.instance, mResourceId);
                    drawable.setBounds(
                            0, 0, drawable.getIntrinsicWidth(), drawable.getIntrinsicHeight()
                    );
                } catch (Exception e) {
